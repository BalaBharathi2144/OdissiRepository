<style type="text/css">
	...
	h5 { font-size: 14px; }
	h6 { font-size: 12px; }
	p { margin: 0 0 20px; line-height: 1.0; }
	...
	hr { border-top: 1px solid #e4e7e9; margin-bottom: 0px; margin-top: 10px; }
	.btn { font-family: 'Source Sans Pro', sans-serif; font-size: 16px; text-transform: capitalize; font-weight: 700; padding: 12px 24px; letter-spacing: 0px; border-radius: 3px; line-height: 1; -webkit-transition: all 0.5s; -moz-transition: all 0.5s; transition: all 0.5s; word-wrap: break-word; white-space: normal !important; }
	...
	.footer { background-color: #08202e; padding-top: 20px; color: #636e74; font-weight: 400; font-size: 17px; }
	.footer-line { border-color: #152e3d; }
	.footer-widget { padding-bottom: 20px; }
	.footer-title { font-size: 24px; font-weight: 600; margin-bottom: 22px; color: #fff; }
	...
	.tiny-footer { font-size: 14px; padding: 4px 0px; font-weight: 600; background-color: transparent; border-top: 1px solid #152e3d; color: #888d90; line-height: 1; }
</style>
	<footer>
    <!-- footer -->
    <div class="footer">

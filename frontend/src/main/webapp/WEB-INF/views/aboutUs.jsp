                    ...
                    <div class="row">
						<div class="col-md-7 col-sm-6">
							<div class="about-title clearfix">
								<h1>About <span>Odissi</span></h1>
								<h3>OUR EXPERTISE. YOUR CUSTOMIZED STORE. </h3>
								<p class="about-paddingB">Since 2018, Odissi Bookstore has provided quality books to customers around the world. In the past three years, we have shipped over a half million books. Our ever growing inventory includes new and pre-owned textbooks, novels, teacher resources, workbooks, professional development materials, and more. These materials come from our vast warehouse and an extensive nationwide network of dealers and distributors, ensuring that you can get what you need when you need it. </p>
								<p>All of our materials are evaluated by highly trained staff to ensure they are properly assessed for condition and catalogued so that your expectations are met when purchasing from us.</p>

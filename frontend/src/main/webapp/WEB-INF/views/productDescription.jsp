	...
	<div class="row">
		...
		<div class="col-12 col-lg-6">
			<div class="card bg-light mb-3" style="width:80%;">
				<div class="card-body">
					<img class="img-fluid"
						src="${cr}/resources/pimages/${myproduct.product_Id}.jpg" height="450" style="max-height: 500px;" width="100%" />
				</div>
			</div>
		</div>
		<!-- Add to cart -->
			...
			<div class="card bg-light mb-3" style="width:80%;">
				<div class="card-body">
					...
					<p class="price_discounted"
						style="color: #0762ff; font-size: 110%;">${myproduct.product_Author}</p>
					<p class="price_discounted ">Rs.${myproduct.price}</p>
					<p class="price_discounted"
						style="color: #0762ff; font-size: 110%;">Supplier Name: ${myproduct.supplier.supplier_Name}</p>
